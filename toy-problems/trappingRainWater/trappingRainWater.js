...
Plan:
  create and assign leftMax to 0
  iterate through and find left maxes
    replace maxes[i] with leftMax
    set leftMax to the max of leftMax and the current height

  create and assign rightMax to 0
  iterate through and find right maxes
    ...
    set rightMax to the max of rightMax and the current height
